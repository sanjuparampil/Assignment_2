...
def read(doc_name, col):
    ...
    d_frame_tr = d_frame_tr.rename(columns={0:"AFW",1:"ARE",2:"AUS",3:"BGD",4:"CHN",5:"GBR",6:"IND",7:"JPN",8:"THA",9:"TUR",10:"USA"})
...
#Reading to dataframe,setting the required columns,dropping unwanted columns,renaming columns,
#dropping null values and transposing for all dataframes
...
df_co2_tr =df_co2_tr.rename(columns={0:"AFW",1:"ARE",2:"AUS",3:"BGD",4:"CHN",5:"GBR",6:"IND",7:"JPN",8:"THA",9:"TUR",10:"USA"})
...
df_co2_tr = df_co2_tr[["AFW","ARE","AUS","BGD","CHN","GBR","IND","JPN","THA","TUR","USA"]].mean()
